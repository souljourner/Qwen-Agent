...
4. **Capability has outgrown the security model** — *email channel locked 2026-07-11*: send_email delivers to the owner only (no recipient param, allowlist-enforced); hand-rolled SMTP blocked in exec/code/file-writes with blocked_email health alerts. Remaining: approval tiers, browser-content trust, secrets isolation.
